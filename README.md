...
Pour installer mc-script copier coller les commandes suivantes dans un terminale (demande un accet root)
Vous devez disposer de packet wget

1 : cd /home

2: sudo wget https://github.com/zendrique/mc-script/releases/download/0.13/script.sh && sudo bash script.sh
