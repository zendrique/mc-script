...
echo "Pour démarer votre serveur faites la commande : sh /home/tuinity/start.sh" >> info-tuinity.txt
...
clear
echo "Terminer !"
echo "Pour démarer votre serveur faites la commande : sh /home/tuinity/start.sh"
