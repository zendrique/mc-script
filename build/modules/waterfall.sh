...
echo "Pour démarer votre serveur faites la commande : sh /home/waterfall/start.sh" >> info-waterfall.txt
...
clear
echo "Terminer !"
echo "Pour démarer votre serveur faites la commande : sh /home/waterfall/start.sh"
