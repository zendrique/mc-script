...
echo "Pour démarer votre serveur faites la commande : sh /home/travertine/start.sh" >> info-travertine.txt
...
clear
echo "Terminer !"
echo "Pour démarer votre serveur faites la commande : sh /home/travertine/start.sh"
